...
namespace FaceEmojiClient
{
    public static class Strings
    {
        ...
        public static readonly string AboutMoments = "About Moments";
        public static readonly string AddAFriend = "Add a Friend";
        public static readonly string AddingFriend = "Adding Friend";
        public static readonly string BecomeFriends = "Become Friends";
        public static readonly string BuildYourOwnMoments = "Build Your Own Moments";
        ...
        public static readonly string FriendAdded = "Friend Added";
        public static readonly string FriendRequestFailed = "Friend Request Failed";
        ...
        public static readonly string Moments = "Face Emoji";
        ...
        public static readonly string PenColor = "Pen Color";
        public static readonly string PoweredByOpenSource = "Powered By Open Source";
        public static readonly string Send = "Send";
        public static readonly string SendingMoment = "Sending Moment";
        public static readonly string SendMoment = "Send Moment";
        ...
        public static readonly string PierceBogganLink = "http://www.twitter.com/pierceboggan";
        public static readonly string AlabamaWikipediaLink = "https://en.wikipedia.org/wiki/Alabama";
        ...
        public static readonly string PoweredByOpenSourceLink = "https://github.com/pierceboggan/Moments/blob/master/OpenSource.md";
