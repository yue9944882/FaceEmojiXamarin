...
[assembly: ExportRenderer(typeof(FaceEmojiClient.View.Xaml.CameraPage), typeof(FaceEmojiClient.Droid.CameraPage))]
namespace FaceEmojiClient.Droid
{
    ...
    public class CameraPage : PageRenderer, TextureView.ISurfaceTextureListener
    {
        ...
        private async void TakePhotoButtonTapped(object sender, EventArgs e)
        {
            ...
            var navigationPage = new NavigationPage(new DrawEmojiPage(imageBytes))
            {
            ...
            MessagingCenter.Subscribe<CameraPage, NativeNavigationArgs>(App.currentPage, NativeNavigationArgs.NativeNavigationMessage, HandlePopupCameraPage);
        }
